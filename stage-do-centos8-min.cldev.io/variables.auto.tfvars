...
# -- Application --
app_name = "stage-do-centos8-min"
app_dns = [
  "stage-do-centos8-min", # stage-do-centos7-latest.cldev.io
...
app_droplet_image = "centos-8-x64" # Supported system images (centos-8-x64, centos-7-x64)
